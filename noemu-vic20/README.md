...
The src directory contains a version of Kulls which is expected to operate within the
original VIC-20 hardware with:

- custom-made battery-backed 24kB RAM
- custom-made joysticks
...
For the reasons given above, this no-emulator version is untested.
